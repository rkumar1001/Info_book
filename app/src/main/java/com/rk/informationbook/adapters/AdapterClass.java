...
import com.rk.informationbook.activity.CountriesActivity;
import com.rk.informationbook.activity.LeadersActivity;
import com.rk.informationbook.activity.MuseumsActivity;
import com.rk.informationbook.activity.WondersActivity;
...
public class AdapterClass extends RecyclerView.Adapter<AdapterClass.CardViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CardViewHolder holder, int position) {
        ...
        holder.imageViewSplash.setImageResource(context.getResources().getIdentifier(model.getImageNmme(),"drawable",context.getPackageName()));
